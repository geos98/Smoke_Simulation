...
public:
  ...
  */
  void place(const nanogui::Vector3f &targetPos, const double phi, const double theta,
  ...
  */
  ...
  nanogui::Vector3f position() const { return pos; }
  nanogui::Vector3f view_point() const { return targetPos; }
  nanogui::Vector3f up_dir() const { return c2w.row(1); }
...
private:
  ...
  nanogui::Vector3f pos, targetPos;
